module.exports = {
  types: [
    ...
    { value: 'docs', name: '文档变动' },
    { value: 'style', name: '不影响代码含义的变化(空白、格式化、缺少分号等)' },
    { value: 'refactor', name: '重构代码，既不修复错误也不添加功能' },
    { value: 'perf', name: '性能优化' },
    { value: 'test', name: '测试相关' },
    { value: 'build', name: '影响构建系统或外部依赖关系的更改' },
    { value: 'ci', name: '更改持续集成文件和脚本' },
